...
import { FaCog, FaForward, FaSave, FaSpotify } from "react-icons/fa";
...
export default function About() {
  return (
    <>
      <Container>
        <h5>
          Deej-A.I. uses artificial intelligence to automatically generate playlists of tracks that go well
          together. It was trained using hundreds of thousands of Spotify tracks and user playlists.
        </h5>
        <div style={{ marginTop: '10px' }} />
        <h5>
          Create a playlist by choosing the tracks (if any) that you would like to include.
        ...
        <h5>
          ...
          is playing. If you click on this, Deej-A.I. will search for similar sounding tracks in its database.
        ...
        <h5>
          ...
          playlists as well as a couple of aspects of how they are generated. If <i>creativity</i> is set to 0,
          then tracks are selected based on similar artists ("spotify users also included in their
          playlists..."). If creativity is set to 1, then tracks are chosen with similar sound, energy, mood
          and instrumentation. It does this by simply "listening" and not using any information about the
          tracks themselves. You can use the <i>noise</i> setting to add a bit of randomness.
        </h5>
        <div style={{ marginTop: '10px' }} />
